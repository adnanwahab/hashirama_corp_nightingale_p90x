...
//"capture-frame": "ffmpeg -i rtsp://192.168.1.138:8554/mystream -vf \"fps=62.5\" -strftime 1 \"./public/most_recent.jpg\"",
	...
	//https://github.com/tmc/langchaingo?utm_campaign=awesomego&utm_medium=referral&utm_source=awesomego
	//https://3hentai.net/tags/huge-penis-male?sort=popular
	//https://www.xvideos.com/video.ibbdhdv5da2/sexy_sara_stone_takes_a_at_the_huge_cock_of_whitezilla
	// https://www.xvideos.com/video.ibbdhdv5da2/sexy_sara_stone_takes_a_at_the_huge_cock_of_whitezilla
	// https://hdporncomics.com/boku-no-harem-academia-4-wa-koakuma-no-itazura-my-harem-academia-4-mischiefs-of-a-little-devil-superheroes-tv-movies-sex-comic/
	// https://www.xvideos.com/video.klumoih0166/thick_blonde_girl_with_big_natural_boobs_fucked_during_audition
	// https://www.xvideos.com/video.itlfuth10f3/short_hair_busty_amateur_fucks_like_a_champ
	// https://3hentai.net/d/651014
	// https://3hentai.net/d/441625/47
	// https://hdporncomics.com/tsuyoki-na-hitozuma-netorare-cheating-group-sex-mature-sex-comic/
	// https://hdporncomics.com/mha-jay-marvel-superheroes-fetish-western-romance-sex-comic/
	//1. flawless OPS  > LOL
	//2. FLAW LESS TELEOP
	//3. automate LIFE
	//4. webRTC
	// 5. WAYLAND WOW - pixel stream ?
	// 6.l42loopback
	// 7. IPC benchmakrs
	// 8.
	//
	//
	// golang = unix / network / systems
	// python = compute
	//
	...
	// limit time surfing
	//
	// Adoption, AI, and Collaboration.
	// robotics
	// home lab - tools for applying gpu to media (computer vision, llm)
	// text ed + browser + llm
	//e eza, fzf, rg, zoxide, and bg.
